...
const BookManager = () => {
  ...
  const baseUrl = `${config.url}/books`;
  ...
  const handleEdit = (book) => {
    setBook(book);
    setEditMode(true);
    setMessage(`Editing book with ID ${book.id}`);
  };
                  ...
                  <tr key={book.id}>
                    ...
                    <td>
                      <div className="action-buttons">
                        <button className="btn-green" onClick={() => handleEdit(book)}>Edit</button>
                        <button className="btn-red" onClick={() => deleteBook(book.id)}>Delete</button>
                      </div>
                    </td>
                  </tr>
                ))}
